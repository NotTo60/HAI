...
server_all_inactive = ServerEntry(
    ...
    os="linux",
    tunnel_routes=[
        TunnelRoute(name="route1", active=False, hops=[TunnelHop(ip="1.1.1.1", user="a", method="ssh")]),
        TunnelRoute(name="route2", active=False, hops=[TunnelHop(ip="2.2.2.2", user="b", method="ssh")]),
    ]
)
...
server_all_fail = ServerEntry(
    ...
    os="linux",
    tunnel_routes=[
        TunnelRoute(name="route1", active=True, hops=[TunnelHop(ip="1.1.1.1", user="a", method="ssh")]),
        TunnelRoute(name="route2", active=True, hops=[TunnelHop(ip="2.2.2.2", user="b", method="ssh")]),
    ]
)
